...
- Markdown report synthesis backed by persisted report artifacts, with low-quality/off-query claim filtering, a pre-report quality gate, and expanded Chinese deterministic sections when evidence is sufficient
